...
let elementoHabilidades = document.querySelector(".titulo__destaque__habilidades");
...
function escreverHabilidades() {
    if (contadorDeLetrasHabilidades < habilidades.length) {
        elementoHabilidades.textContent += habilidades.charAt(contadorDeLetrasHabilidades);
